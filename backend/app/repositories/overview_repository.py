...
class OverviewService:
    ...
    def get_workspace_overview(
        ...
        return WorkspaceOverviewRead(
            ...
            counters=WorkspaceOverviewCounters(
                ...
                run_statuses=self._workspace_run_status_counters(workspace_id),
    ...
    def get_project_overview(
        ...
        return ProjectOverviewRead(
            ...
            counters=ProjectOverviewCounters(
                ...
                run_statuses=self._project_run_status_counters(project_id),
    ...
    def _workspace_run_status_counters(self, workspace_id: UUID) -> RunStatusCounters:
    ...
    def _project_run_status_counters(self, project_id: UUID) -> RunStatusCounters:
        return RunStatusCounters(
